 ...
 */
struct GPS {
    var latitude: Double = 2.3
    var longitude: Double = 3.4
...
var favoriteBook = Book(title: "Persona", author: "Narakami", pages: 190, price: 40.99)
/*:
...
var someonesHeight = Height(heightInInches: 65, heightInCentimeters: 165.1)
...
var myHeight = Height(heightInInches: 70, heightInCentimeters: 201.6)
